...
Figure 1: an example of pdf after evaluating (=knitting) the Rmarkdown code
...
1. You may download the document as a Word file and use track changes in MS Word (or similar software, Figure 3). You can then send the edited document to the lead author. Please note, however, that this way of collaborating will increase the workload of the lead author and editing on Google Docs is the preferred method.
